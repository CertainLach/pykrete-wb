...
Options:
      ...
      --input-encoding <INPUT_ENCODING>
          ...
          The result will not be compatible with standard AES, you would need server side support for encrypting/decrypting the in
put/output.
...
put/output.
      ...
      --no-internal-encodings
          ...
          Can greately reduce the code size, but right now it can only make it much more compressible (XOR tables will have very r
epetetive pattern).
